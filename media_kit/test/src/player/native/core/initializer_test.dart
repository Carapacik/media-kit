...
void main() {
  ...
  test('initializer-init', () {
    expect(Initializer(mpv).create((_) async {}), completes);
  });
  ...
  test('initializer-dispose', () async {
    ...
    expect(() => Initializer(mpv).dispose(handle), returnsNormally);
  });
  test('initializer-callback', () async {
    ...
    final handle = await Initializer(mpv).create((event) async {
